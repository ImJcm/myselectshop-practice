...
class ProductServiceTest {
    ...
    void test1() {
        ...
        ProductRequestDto requetProductDto = new ProductRequestDto(
                "Apple <b> 맥북</b> <b>프로</b> 16형 2021년 <b>M1</b> Max 10코어 실버",
                "http://shopping-phinf.pstatic.net/main_2941337/29413376619.20220705152340.jph",
                "https://search.shopping.naver.com/gate.nhn?id=29413376619",
                3515000
        );

        Product product = new Product(requetProductDto, user);
    ...
    void test2() {
        ...
        // then
        assertEquals(
                "유효하지 않은 관심 가격입니다. 최소 " +ProductService.MIN_MY_PRICE + "원 이상으로 설정해주십쇼.",
