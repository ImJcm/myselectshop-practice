...
class UserProductMvcTest {
    ...
    private void mockUserSetup() {
        // Mock 테스트 유져 생성
        String username = "jcm970909";
        String password = "jcm1234";
        String email = "jcm@sparta.com";
    ...
    void test2() throws Exception {
        ...
        signupRequestForm.add("username", "jcm970909");
        signupRequestForm.add("password", "jcm1234");
        signupRequestForm.add("email", "jcm@sparta.com");
